...
# === Nombres de los indicadores en mayúsculas ===
nombres_indicadores = [
...
# === Pestaña Consolidado ===
with tabs[-1]:
    st.markdown("<h2 style='font-size: 12pt;'>CONSOLIDADO DE JUT</h2>", unsafe_allow_html=True)
...
for i, ind in enumerate(["Indicador2", "Indicador3", "Indicador4", "Indicador5"]):
    with tabs[i+1]:
        nombres_indicadores = [
            "% DE RENDICIÓN DE CUENTAS MENSUAL PRESENTADA",
            "% DE EJECUCIÓN MONTO APROBADO DE LOS PROYECTOS",
            "% DE EJECUCIÓN FINANCIERA DE LOS PROYECTOS",
            "% DE EJECUCIÓN FÍSICA DE LOS PROYECTOS",
        ]
